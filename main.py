...
########## Setting SVR and IterativeImputer
svr = SVR()
iterimp = IterativeImputer(estimator=svr, max_iter=200, tol=1e-12, verbose=2)
...
########## Creating a csv file
micedataset.to_csv("multivariate-method-results/AMR-and-NSH-Buoy-Data1394-normalized-mice-svr.csv")